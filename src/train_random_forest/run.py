...
def go(args):
    ...
    # get the train and validataion artifact from wandb
    ...
    # Export and upload the model we to W&B
    path_dir = 'random_forest_dir'
    mlflow.sklearn.save_model(sk_pipe, path_dir)

    artifact = wandb.Artifact(
            args.output_artifact,
            type='model',
            description="trained random forest classifier",
            metadata=rf_config)

    artifact.add_dir(path_dir)
